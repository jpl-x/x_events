...
Vector3dArray EkltVioUpdater::getMsckfInliers() const {
  return msckf_inliers_;
}

Vector3dArray EkltVioUpdater::getMsckfOutliers() const {
  return msckf_outliers_;
}

void EkltVioUpdater::setMeasurement(const VioMeasurement &measurement) {
...
void EkltVioUpdater::applyQRDecomposition(Matrix &h, Matrix &res, Matrix &R) {
