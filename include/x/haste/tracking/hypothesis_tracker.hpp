...
#include <x/haste/core/event_window.hpp>
#include <x/haste/core/hypotheses_manager.hpp>
#include <x/haste/core/interpolator.hpp>
#include <x/haste/core/patch.hpp>
...
class HypothesisPatchTracker {
 public:
  ...
  using Scalar = double; // TODO: it could be templated.
...
#include <x/haste/tracking/hypothesis_tracker_impl.hpp>